...
public class InterlockingImpl_Test {
    ...
    @Test
    public void testNorthboundFreightRoute() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("f1", 11, 3);
    ...
    @Test
    public void testFourToThreeFreightRoute() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("f1", 4, 3);
    ...
    @Test
    public void testSouthboundPassengerToEight() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("p1", 1, 8);
    ...
    @Test
    public void testSouthboundPassengerToNine() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("p1", 1, 9);
    ...
    @Test
    public void testSouthboundPassengerFromThreeToEight() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("p1", 3, 8);
    ...
    @Test
    public void testSouthboundPassengerFromThreeToNine() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("p1", 3, 9);
    ...
    @Test
    public void testMoveDuplicateNamesSameRoundOnlyCountsOnce() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("t1", 1, 4);
    ...
    @Test
    public void testMoveBlockedBecauseDestinationOccupied() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("t1", 1, 4);
        i.addTrain("t2", 3, 11);
    ...
    @Test
    public void testHeadOnSwapPrevention() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("p1", 3, 8);
        i.addTrain("p2", 9, 2);
    ...
    @Test
    public void testTurnoutConflictPrevention() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("p1", 3, 8);
        i.addTrain("p2", 10, 2);
    ...
    @Test
    public void testTrainExitAfterDestinationReachedInLaterRound() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("t1", 3, 11);
    ...
    @Test
    public void testCannotAddSecondTrainToOccupiedIntermediateAfterMove() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("t1", 1, 4);
        i.moveTrains(new String[]{"t1"});
    ...
    @Test
    public void testGetTrainReturnsMinusOneAfterExitNotException() {
        InterlockingImpl i = new InterlockingImpl();
        i.addTrain("t1", 1, 4);
